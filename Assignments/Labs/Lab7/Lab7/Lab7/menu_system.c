 ...
 *							menu_type: Use 'I' or 'i' for integer-based (i.e. 1-10) menu,
 *													use 'C' or 'c' for character-based (i.e. A-Z) menu.
 ...
 *************************************************************/
int display_standard_menu (char menu_title[], char menu_items[], char menu_type, int num_items, int min_items)
{
	...
	do
	{
		...
		else if ((menu_type == 'c') || (menu_type == 'C'))
		{
	...
	} while (!is_valid_item (menu_type, option, num_items, min_items));
 ...
 *************************************************************/
int is_valid_item (char menu_type, int option, int num_items, int min_items)
{
	// set validity to no
	int valid = 0;
	...
	{
		printf ("Please enter valid input.5");
	}
	// return validity
	return valid;
}